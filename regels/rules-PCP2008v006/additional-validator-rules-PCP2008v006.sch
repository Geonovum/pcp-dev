...
<!--
/*******************************************************************************
 * File: additional-validator-rules-PCP2008v005.sch
 * (C) Logica, 2008
 *
 * Info:
...
Foutcode AD13: <iso:name/> dient een geometrische inhoud te hebben.
	...
	<iso:pattern name="Grensdatum">
		
		<iso:rule context="//imro:PlanstatusEnDatum_PCP[imro:planstatus='vastgesteld']">
